...
import { exportVideo, getResolution, QUALITY_PRESETS } from '../lib/exporter.js';
...
const QUALITIES = ['studio', 'social', 'web', 'webLow'];
...
export default function ExportModal({
  ...
  }, [sourceBlob, exportSeconds, mouse, segments, display, background, crop, trim, size, fps, format, quality, onClose]);
...
function ExportProgress({ sourceLabel, destLabel, progress, progressStage, elapsed, eta, onStop }) {
...
function ExportError({ message, onBack, onClose }) {
  return (
